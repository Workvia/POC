...
const StyledSparkleIcon = styled.svg`
  width: 16px;
  height: 16px;
  flex-shrink: 0;
  color: #ffffff;
...
const StyledPopover = styled.div<{ isOpen: boolean; $isConversationMode?: boolean }>`
  position: absolute;
  ${({ $isConversationMode }) => $isConversationMode ? 'bottom: calc(100% + 8px);' : 'top: calc(100% + 8px);'}
  left: 0;
  width: 300px;
...
const StyledPopoverHeader = styled.div`
  color: ${({ theme }) => theme.name === 'dark' ? '#999999' : '#666666'};
  margin-bottom: 4px;
  margin-top: 8px;
  padding: 0 4px;
  font-size: 11px;
  ...
  return (
    <>
        ...
        {!hasStartedConversation && (
          <StyledGreetingSection>
            <StyledSparkleContainer>
              <img src="/images/icons/web/sparkle.png" alt="sparkle" width="14" height="14" />
            </StyledSparkleContainer>
            <StyledGreetingText>{getGreeting()}, {firstName}</StyledGreetingText>
          </StyledGreetingSection>
        )}

        {/* Chat History Section - Show messages when conversation has started */}
      ...
      >
          ...
          <StyledButtonRow>
            <StyledLeftButtons>
              ...
              <StyledPopoverContainer>
                ...
                <StyledPopover isOpen={showSourcesPopup} $isConversationMode={hasStartedConversation} ref={popoverRef}>
        ...
        {/* Suggestion Prompts - Only show before conversation starts */}
        {!hasStartedConversation && (
      ...
      {/* Previous Chats Section - Only show before conversation starts */}
      {!hasStartedConversation && (
